...
namespace NSWF::tags
{
    class DefineTextTag : public SwfTag, public CharacterIdTag
    {
    public:
        DefineTextTag(SwfStreamReader& reader, size_t size) : SwfTag(SwfTagType::DefineText, size)
        {
            ...
            {
                reader.backtrack();
                records.emplace_back(reader.readTextRecord(1, glyphBits, advanceBits));
            }
        }
