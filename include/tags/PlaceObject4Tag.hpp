...
namespace NSWF::tags
{
    class PlaceObject4Tag : public SwfTag
    {
    public:
        ...
        PlaceObject4Tag(SwfStreamReader& _reader, size_t size)
            : SwfTag(SwfTagType::PlaceObject4, size)
        {
            ...
            // Handle AMF data when I understand what that means
        }
        ...
        // TODO: learn what AMFdata is and if I need it AMFData amfData;
    };
}
